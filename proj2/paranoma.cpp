...
int main(int argc, char* argv[])
{
	...
	double H[3][3] = { { 0.818425476647765,	0.0352235212928494,	200.974574548502 },
	                  { -0.167626502513787,	0.971950934055715,	19.0451316252492 },
	                  { -0.000429385023170290,	8.10289679603329e-05,	1 } };
	double H_inv[3][3] = { { 1.10152442382431, - 0.0214976704589587, - 220.968976469348 },
							{ 0.180992743341688,	1.02696237328948, - 55.9335731629382 },
						 { 0.000458312435045156, - 9.24444789698676e-05, 0.909651470626521 } };
	if (argc < 3) {
